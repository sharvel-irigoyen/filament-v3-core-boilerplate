...
class User extends Authenticatable implements HasAvatar, FilamentUser
{
    ...
    use HasFactory, Notifiable, HasRoles, TwoFactorAuthenticatable, CausesActivity, LogsActivity, SoftDeletes;
     ...
     * @var list<string>
     */
    protected $fillable = ['name', 'email', 'password', 'type', 'avatar_url'];
    ...
    {
        // Usuarios soft-deleted no pueden acceder al panel
        if ($this->trashed()) {
            return false;
        }
